...
Original file is located at
    https://colab.research.google.com/drive/1N03euNgZq46k8BARFjZke3BzYnL01_F4
"""
...
def fine_tune_trocr_model(train_loader, val_loader, output_dir, num_epochs=3):
    ...
    # ---- ENHANCED FIX: Set token IDs in all required places ----
    # Get token IDs from the tokenizer
    pad_token_id = processor.tokenizer.pad_token_id  # Usually 1 for most models
    decoder_start_token_id = processor.tokenizer.bos_token_id  # Usually 2 for most models
    eos_token_id = processor.tokenizer.eos_token_id  # Usually 3 for most models
    ...
    print(f"Model configuration after updates:")
    print(f"  - pad_token_id: {model.config.pad_token_id}")
    print(f"  - decoder_start_token_id: {model.config.decoder_start_token_id}")
    print(f"  - eos_token_id: {model.config.eos_token_id if hasattr(model.config, 'eos_token_id') else 'Not set'}")
    # ---- End of enhanced fix ----
    ...
    training_args = Seq2SeqTrainingArguments(
        ...
        # ---- Add this parameter to avoid generation issues ----
    ...
    trainer = Seq2SeqTrainer(
        ...
        # ---- Add data collator to ensure proper padding ----
